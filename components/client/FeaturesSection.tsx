      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-32 xl:gap-60 items-center max-w-6xl mx-auto">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-haven-white leading-relaxed">
                  Snap a photo and let HAVEN&apos;s AI estimate your calories, protein, carbs, and fat instantly. Logging has never been faster.
                </p>
              </div>
            </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-bold text-haven-white mb-2">
                Log With Your Voice or Text
              </h3>
              <p className="text-haven-white leading-relaxed">
                Say what you ate or type it out, HAVEN figures out the rest. 
                Quick, flexible logging that fits however your day is going.
              </p>
            </div>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-haven-white mb-2">
                  Food Journal & Weekly Recap
                </h3>
                <p className="text-haven-white leading-relaxed">
                  Every meal tells a story. Your journal captures your habits, patterns, and triggers, and your weekly recap turns them into insight.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-haven-white leading-relaxed">
                  Plan your week before it starts. Set Treat Days, see how your budget distributes, and let HAVEN adjust your daily targets automatically.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-haven-white leading-relaxed">
                  Bite-sized articles on nutrition science, mindset, and sustainable habits. No jargon, no shame just insight that makes the journey stick.
                </p>
              </div>
            </div>
